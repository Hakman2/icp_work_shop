...
var require_ieee754 = __commonJS({
  "node_modules/ieee754/index.js"(exports) {
    ...
    exports.write = function(buffer, value2, offset, isLE2, mLen, nBytes) {
      var e, m, c;
      var eLen = nBytes * 8 - mLen - 1;
      var eMax = (1 << eLen) - 1;
      var eBias = eMax >> 1;
...
var Certificate = class _Certificate {
  ...
  static async create(options) {
    ...
    const cert = new _Certificate(options.certificate, options.rootKey, options.canisterId, blsVerify2, options.maxAgeInMinutes);
    await cert.verify();
    return cert;
  }
  lookup(path) {
...
function check_canister_ranges(params) {
  ...
  const ranges_arr = decode2(rangeLookup);
...
*/
//# sourceMappingURL=chunk-PW7LZCI3.js.map
